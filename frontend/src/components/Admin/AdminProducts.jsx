...
const AdminProducts = () => {
  const { products, page, setPage, fetchProducts, loading, totalPages, search, setSearch } = ProductData()
  ...
  return (
    <div>
      <div className='flex flex-col md:flex-row items-center justify-between gap-4 mb-6'>
        <h2 className='text-2xl font-bold w-full md:w-auto text-center md:text-left'>Semua Produk</h2>
         {/* Input Judul */}
         <div className="w-full md:flex-1 flex justify-center">
            <Input
              type="text"
              placeholder="Masukkan judul yang dicari"
              className="w-full max-w-lg px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 
